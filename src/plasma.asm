 ...
 * TODO changer correctement les valeurs CRTC pour éviter un saut
 */
INIT
.detect_crtc
    call TestCRTC
...
.modif_code_border
    ...
    ld a, 6 : ld (BORDER0.val1+1), a
    ld hl, 0x0000 + (31 )*256: ld (BORDER0.val2+1), hl
...
DIFF_REG7 = (34 - 30)
 call VBL
 ld bc, 0xbc00+4 : out (c), c : ld bc, 0xbd00+38-DIFF_REG7 : out (c), c
 halt
 halt
 ld bc, 0xbc00+4 : out (c), c : ld bc, 0xbd00+38 : out (c), c
 ld bc, 0xbc00+7 : out (c), c : ld bc, 0xbd00+34 : out (c), c
